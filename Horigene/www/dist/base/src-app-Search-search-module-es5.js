...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["src-app-Search-search-module"], {
  ...
  function srcAppSearchSearchRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_Search_search_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
  ...
  function srcAppSearchSearchComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var rxjs_add_observable_empty__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! rxjs/add/observable/empty */
    "./node_modules/rxjs-compat/_esm2015/add/observable/empty.js");
    /* harmony import */


    var rxjs_add_operator_repeat__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    function SearchComponent_div_10_p_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function SearchComponent_div_10_ul_2_li_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function SearchComponent_div_10_ul_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var SearchComponent = /*#__PURE__*/function () {
      ...
      _createClass(SearchComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.subscription = new rxjs__WEBPACK_IMPORTED_MODULE_1__["Subscription"]();
          this.searchService.search(this.searchTerm) // Catch errors
          ["catch"](function (err) {
            console.error(err);
            _this.results = null;
            return rxjs_Observable__WEBPACK_IMPORTED_MODULE_3__["Observable"].empty();
          }) // re-subscribe to completed observable
          .repeat().subscribe(function (results) {
            _this.isVisible = true;
            console.log(results);

            if (results) {
              _this.results = results['Value'] ? results['Value'] : [];
            } else {
              _this.results = null;
            }
          });
    ...
    SearchComponent.ɵfac = function SearchComponent_Factory(t) {
      return new (t || SearchComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_Services_search_service__WEBPACK_IMPORTED_MODULE_6__["SearchService"]));
    };
    ...
    SearchComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 11,
      vars: 1,
      consts: [[1, "s010"], ["src", "../../assets/logo/Horigene.png", "alt", "", 1, "logo"], [1, "inner-form"], [1, "basic-search"], [1, "input-field"], ["id", "search", "type", "text", "placeholder", "Search individual proteins by ID or keyword or Sequence", 3, "keyup"], [1, "icon-wrap"], ["xmlns", "http://www.w3.org/2000/svg", "width", "24", "height", "24", "viewBox", "0 0 24 24"], ["d", "M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"], ["class", "dropdown-menu list", 4, "ngIf"], [1, "dropdown-menu", "list"], ["class", "padding-left-md padding-top-md", 4, "ngIf"], ["class", "list-unstyled text-muted margin-bottom-none", 4, "ngIf"], [1, "padding-left-md", "padding-top-md"], [1, "list-unstyled", "text-muted", "margin-bottom-none"], [4, "ngFor", "ngForOf"]],
      template: function SearchComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("keyup", function SearchComponent_Template_input_keyup_6_listener($event) {
            return ctx.searchTerm.next($event.target.value);
          });
  ...
  function srcAppSearchSearchModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    SearchModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _search_routing_module__WEBPACK_IMPORTED_MODULE_3__["SearchRoutingModule"]]]
    });
...
//# sourceMappingURL=src-app-Search-search-module-es5.js.map